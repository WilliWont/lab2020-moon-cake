 ...
 * @author Will
 */
public class CanAuthenFilter implements Filter {
    ...
    public CanAuthenFilter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CanAuthenFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CanAuthenFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            else if(userRole!=null && userRole ==AccountHelper.THIRD_PARTY_ROLE){
                loginDTO = user;
            }
            
            if (loginDTO != null && userRole != AccountHelper.THIRD_PARTY_ROLE) {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("CanAuthenFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CanAuthenFilter()");
        }
        StringBuffer sb = new StringBuffer("CanAuthenFilter(");
