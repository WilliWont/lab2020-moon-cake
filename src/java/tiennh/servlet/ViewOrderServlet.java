...
import tiennh.ordertable.OrderTableDTO;
...
public class ViewOrderServlet extends HttpServlet {
    ...
    private final String ORDER_PAGE = "viewOrderPage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderTableDTO> orderList = orderDAO.getOrder(username);
            ...
            String url = siteMap.getString(ORDER_PAGE);
