...
public class CreateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (imagePart == null) {
                returnMsg += "empty image field\n";
                hasError = true;
            } else if (imagePart.getSize() > CakeHelper.IMAGE_MAX_SIZE_VALUE) {
            ...
            if (!hasError) {
                ...
                int result = dao.createCake(cake, imagePart);

                if (result < 0) {
                    hasError = true;
                    returnMsg += "unable to insert cake\n";
                }
            }
        } catch (Throwable t) {
            hasError = true;
            ...
            if (!hasError) {
                returnMsg = "created successfully";
            }
